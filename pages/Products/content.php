      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Startup Products</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-md-9">
              ...
              <div class="box box-widget">
                ...
                <div class='box-body'>
                  <img class="img-responsive pad" src="../../images/blue.png" alt="Photo">
                  ...
                  <ul class="products-list product-list-in-box">
                    <li class="item">
                      <div class="product-img">
                        <img src="../../images/team/index2.jpg" alt="Product Image">
                      </div>
                    ...
                    <li class="item">
                      <div class="product-img">
                        <img src="../../images/team/index0.png" alt="Product Image">
                      </div>
                      <div class="product-info">
                    ...
                    <li class="item">
                      <div class="product-img">
                        <img src="../../images/team/index1.jpg" alt="Product Image">
                      </div>
                      <div class="product-info">
                    ...
                    <li class="item">
                      <div class="product-img">
                        <img src="../../images/team/index3.jpg" alt="Product Image">
                      </div>
                      <div class="product-info">
