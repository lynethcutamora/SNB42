          ...
          <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <h3 class="profile-username text-center">Jason D. Pitogo</h3>
                  <p class="text-muted text-center">ADMIN</p>

                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>No. of Ideas Posted</b> <a class="pull-right">1,322</a>
                    </li>
                    <li class="list-group-item">
                      <b>Badges</b> <a class="pull-right">   &nbsp;&nbsp;&nbsp;<button class='btn btn-default btn-xs'><i class='fa fa-star' style="color:Gold"></i> <span class="label label-primary">10</span> </button><button class='btn btn-default btn-xs'><i class='fa fa-star' style="color:Silver"></i><span class="label label-primary">5</span> </button><button class='btn btn-default btn-xs'><i class='fa fa-star' style="color:SandyBrown "></i><span class="label label-primary">20</span> </button><button class='btn btn-default btn-xs'><i class='fa fa-star' style="color:Black "></i><span class="label label-primary">0</span> </button></a>
                    </li>
                    <li class="list-group-item">
                      <b>Email</b> <a class="pull-right">Jason.pitogo1@gmail.com</a>
                    </li>
                  </ul>
                ...
                <div class="box-body">
                  ...
                  <p class="text-muted">
                   BSIT - University of Cebu
                  </p>

                  <hr>

                  <strong><i class="fa fa-map-marker margin-r-5"></i> Location</strong>
                  <p class="text-muted">Sangi New Road LLC</p>
              ...
              <div class="nav-tabs-custom">
                ...
                <div class='box-header with-border'>
                  <div class='user-block'>
                    ...
                    &nbsp;&nbsp;&nbsp;<button class='btn btn-default btn-xs'><i class='fa fa-star' style="color:Gold"></i> <span class="label label-primary">10</span> </button><button class='btn btn-default btn-xs'><i class='fa fa-star' style="color:Silver"></i><span class="label label-primary">5</span> </button><button class='btn btn-default btn-xs'><i class='fa fa-star' style="color:SandyBrown "></i><span class="label label-primary">20</span> </button>
                    <span class='description'>November 16 2015 - 7:30 PM</span>
                  </div><!-- /.user-block -->
                  <div class='box-tools'>
                ...
                <div class='box-body'>
                  <img class="img-responsive pad" src="../images/StartNBoost_logoBlue.png" alt="Photo">
                ...
                <div class='box-footer box-comments'>
                  <div class='box-comment'>
                    <!-- User image -->
                    <img class='img-circle img-sm' src='../dist/img/index0.png' alt='user image'>
                    <div class='comment-text'>
                      <span class="username">
                        Lyneth Cutamora
                        <span class='text-muted pull-right'> November 16 2015 - 8:03 PM</span>
                      </span><!-- /.username -->
                     Walay Forever....
                    </div><!-- /.comment-text -->
                  </div><!-- /.box-comment -->
                  <div class='box-comment'>
                    <!-- User image -->
                    <img class='img-circle img-sm' src='../dist/img/index2.jpg' alt='user image'>
                    <div class='comment-text'>
                      <span class="username">
                        Alfie Dimpas
                        <span class='text-muted pull-right'>November 16 2015 - 8:03 PM </span>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName" placeholder="Education">
                        </div>
                      </div>
                      <div class="form-group">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                       ...
                       <li>
                        <a href="#">
                          <img class="contacts-list-img" src="../dist/img/index2.jpg">
                          <div class="contacts-list-info">
                            <span class="contacts-list-name">
                              Alfie Dimpas
                            </span>
                       ...
                       <li>
                        <a href="#">
                          <img class="contacts-list-img" src="../dist/img/index0.png">
                          <div class="contacts-list-info">
                            <span class="contacts-list-name">
                              Lyneth Cutamora
                            </span>
